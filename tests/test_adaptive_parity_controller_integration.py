...
def test_retired_campaign_converts_field_bucket_into_public_spawn_assault() -> None:
    harness = make_harness()
    harness.lua.execute("Policy.Decide = function() return {} end")
    harness.controller.strategicAssaultEnabled = True
    tank = harness.unit(
        entityId=60,
        blueprintId="uel0201",
        position=[20, 2, 20],
    ...
    _set_director_result(
        ...
        "macroPlan",
        {
            ...
            "lanes": {},
            "regions": [
                {"key": "owned-front", "state": "secured", "position": [100, 2, 100]}
            ],
            "intents": [],
        },
    )
